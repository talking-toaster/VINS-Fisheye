...
double Polynomial::getValue(const double in) {
	return Evaluate(in);
}
...
int Polynomial::getPolyOrder() const {
	return m_order;
}
...
eigen_utils::Vector Polynomial::getPolyCoeff() const {
	return m_coeff;
}
...
Polynomial &PolynomialFit::getPolynomial() {
	return *poly;
}
